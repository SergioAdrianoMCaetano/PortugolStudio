programa {
  funcao inicio() {
    //FAZER UM PROGRAMA QUE RECEBE DOIS VALORES E VERIFIQUE SE SÃO MULTIPLOS ENTRE SÍ;
    ...
    se(numeroTeste1 > numeroTeste2){
      ...
      se(resto == 0){
        escreva("\nO valor ", numeroTeste1, " é múltiplo de ", numeroTeste2, "!\n")
      }
      senao{
        escreva("\nO valor ", numeroTeste1, " não é múltiplo de ", numeroTeste2, "!\n")
      }
    }
    ...
    se(numeroTeste2 > numeroTeste1){
      ...
      se(resto == 0){
        escreva("\nO valor ", numeroTeste2, " é múltiplo de ", numeroTeste1, "!\n")
      }
      senao{

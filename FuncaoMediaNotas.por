...
/*Prof. Francisco Viana - Introdução à Lógica de Programação */
programa {
  funcao inicio() {
    ...
    /*Fpo utilizado um "procedimento para gerar uma linha separadora" */
    ...
    /*Como pretendemos calcular notas entre 0 e 10, indique um controle para valores */

...
programa {
  funcao inicio() {
     ...
     * A variável jogador será alterada no decorrer do jogo. Será alterada entre 1 e 2 para cada jogada
...
/**/
    ...
    para(inteiro x = 0; x < 9; x++){
      ...
      senao se(jogador == 2){
        escreva("\nVocê é o jogador ",jogador,". Por favor, escolha a sua jogada:\n")
        escreva("\nDigite uma linha: ")
        leia(linha)
        escreva("\nDigite uma coluna: ")
        leia(coluna)
        se((linha < 3)e(coluna < 3)e(tabuleiro[i][j] == ' ')){
          escreva("Você digitou: (",linha,",",coluna,").\n")
